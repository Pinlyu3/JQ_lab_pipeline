...
scv.pl.velocity_embedding_grid(data_cl,basis='umap',color="lightgrey",arrow_length=2, arrow_color='#CB2314',arrow_size=2,density=1,alpha=1,size=2.5,dpi=600,save=output_file)
